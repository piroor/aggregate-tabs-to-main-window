...
xpi: lint extlib/webextensions-lib-configs/Configs.js
	git submodule update
	cp extlib/webextensions-lib-configs/Configs.js common/
	rm -f ./*.xpi
	zip -r -0 aggregate-tabs-to-main-window.xpi manifest.json _locales common background >/dev/null 2>/dev/null
